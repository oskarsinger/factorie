...
class CTBTransitionBasedParser extends TransitionBasedParser {

  override def prereqAttrs = Seq(classOf[Sentence], classOf[CtbPosTag])
  //TODO take care of utf-8 IO stuff, figure out what is going on with prereqAttrs
}
object CTBTransitionBasedParser(url:java.net.URL) extends CTBTransitionBasedParser(cc.factorie.util.ClasspathURL[CTBTransitionBasedParser](".factorie"))
